package com.oconte.david.recyclerview;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exampleList.add(new ExampleItem(R.mipmap.ic_android, "Line 1", "Line 2"));
        ...
        exampleList.add(new ExampleItem(R.mipmap.ic_android, "Line 7", "Line 8"));
        ...
        exampleList.add(new ExampleItem(R.mipmap.ic_android, "Line 13", "Line 14"));
        ...
        exampleList.add(new ExampleItem(R.mipmap.ic_android, "Line 19", "Line 20"));
        ...
        exampleList.add(new ExampleItem(R.mipmap.ic_android, "Line 25", "Line 26"));
