package com.oconte.david.testapirest.AsyncTask;

import android.util.Log;

import com.oconte.david.testapirest.HttpURLConnection.MyHttpURLConnection;

import java.lang.ref.WeakReference;

public class NewYorkTime extends android.os.AsyncTask<String, Void, String>{
        ...
        public NewYorkTime(Listeners callback){
